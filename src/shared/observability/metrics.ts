...
const observeRequest = (req: Request, res: Response, next: NextFunction) => {
...
const toPrometheus = (snapshot: MetricsSnapshot): string => {
  const lines = [
...
export { observeRequest, getMetricsSnapshot, toPrometheus };
