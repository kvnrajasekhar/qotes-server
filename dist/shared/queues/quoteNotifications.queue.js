...
if (NOTIFICATIONS_ENABLED) {
    exports.quoteNotificationsQueue = quoteNotificationsQueue = new bullmq_1.Queue(queueName, {
...
const enqueueNotificationJob = async (payload, opts = {}) => {
    if (!NOTIFICATIONS_ENABLED) {
        console.info("Notifications disabled; skipping notification enqueue", payload.type);
        return null;
    }
    return quoteNotificationsQueue?.add(payload.type || "send-notification", payload, {
