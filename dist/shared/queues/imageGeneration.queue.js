...
if (IMAGE_GENERATION_ENABLED) {
    exports.imageGenerationQueue = imageGenerationQueue = new bullmq_1.Queue(queueName, {
...
const addImageGenerationJob = async (payload, opts = {}) => {
    if (!IMAGE_GENERATION_ENABLED) {
        console.info("Image generation disabled; skipping image generation job", payload);
        return null;
    }
