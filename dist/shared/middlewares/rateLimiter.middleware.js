...
const createRateLimiter = ({ actionName, burstWindowMs, burstLimit, sustainedWindowMs, sustainedLimit, identifier = "ip", }) => {
    return async (req, res, next) => {
        try {
            ...
            const allowed = await redis_utils_1.redis.slidingWindowRateLimit(burstKey, sustainedKey, Date.now(), burstWindowMs, burstLimit, sustainedWindowMs, sustainedLimit);
            if (!allowed) {
