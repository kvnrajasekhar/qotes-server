...
router.post("/:id", auth_middleware_1.default, (0, express_async_handler_1.default)(async (req, res) => {
    const { type } = req.body;
    if (!type) {
        return (0, responseFormatter_util_1.errorResponse)(res, 400, "Reaction type is required");
    }
    ...
    return (0, responseFormatter_util_1.successResponse)(res, 200, "Quote reaction toggled successfully", result);
}));
router.get("/:id", auth_middleware_1.default, (0, express_async_handler_1.default)(async (req, res) => {
    ...
    return (0, responseFormatter_util_1.successResponse)(res, 200, "Quote reactions retrieved successfully", result);
}));
