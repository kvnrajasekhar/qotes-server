  ...
  (0, express_async_handler_1.default)(async (req, res) => {
    ...
    if (isRequote && !parentQuoteId) {
      return (0, responseFormatter_util_1.errorResponse)(
        res,
        400,
        "Parent quote ID is required for requote",
      );
    }
...
router.patch(
  ...
  (0, express_async_handler_1.default)(async (req, res) => {
    ...
    const updatedQuote = quote_service_1.default.updateQuote(
      quoteId,
      updateData,
    );
    if (!updatedQuote) {
...
router.get(
  ...
  (0, express_async_handler_1.default)(async (req, res) => {
    ...
    const userQuotes = quote_service_1.default.getQuotesByUser(
      userId,
      cursor,
      limit,
    );
    ...
    return (0, responseFormatter_util_1.successResponse)(
      res,
      200,
      "User quotes retrieved successfully",
      userQuotes,
    );
  }),
);
