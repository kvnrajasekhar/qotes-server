...
router.get("/test", (req, res) => {
    return (0, responseFormatter_util_1.successResponse)(res, 200, "System router is working!", {
...
router.get("/routes", (req, res) => {
    ...
    if (!apiKey || apiKey !== process.env.API_KEY_SECRET) {
        return (0, responseFormatter_util_1.errorResponse)(res, 403, "Invalid or missing API key");
    }
    return (0, responseFormatter_util_1.successResponse)(res, 200, "Available API routes", {
...
router.get("/health", (req, res) => {
    ...
    const healthStatus = {
        ...
        features: {
            imageGeneration: process.env.IMAGE_GENERATION_ENABLED === "true"
                ? "enabled"
                : "disabled",
            notifications: process.env.NOTIFICATIONS_ENABLED === "true" ? "enabled" : "disabled",
        },
        memory: {
    ...
    return (0, responseFormatter_util_1.successResponse)(res, 200, "System health", healthStatus);
});
