...
const initTopics_1 = __importDefault(
  require("./infrastructure/kafka/initTopics"),
);
...
const startOptionalMessaging = async () => {
  try {
    logger_util_1.default.info("Starting optional Kafka messaging", {
      service: "kafka",
    });
    ...
    logger_util_1.default.info("Kafka messaging is ready", {
      service: "kafka",
    });
  } catch (err) {
