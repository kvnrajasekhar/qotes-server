...
const collections_route_1 = __importDefault(
  require("./modules/collections/collections.route"),
);
const comment_route_1 = __importDefault(
  require("./modules/comments/comment.route"),
);
...
const preference_route_1 = __importDefault(
  require("./modules/preferences/preference.route"),
);
const quote_route_1 = __importDefault(require("./modules/quotes/quote.route"));
const reaction_route_1 = __importDefault(
  require("./modules/reactions/reaction.route"),
);
const safety_route_1 = __importDefault(
  require("./modules/safety/safety.route"),
);
const search_route_1 = __importDefault(
  require("./modules/search/search.route"),
);
const user_route_1 = __importDefault(require("./modules/users/user.route"));
const system_route_1 = __importDefault(
  require("./modules/system/system.route"),
);
